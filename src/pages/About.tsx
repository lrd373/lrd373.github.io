...
const BioParagraph = ({
  ...
  return (
    <p
      className={`font-secondary md:pl-unset px-3 text-justify text-sm leading-6 md:col-span-full md:row-span-1 md:pr-5 md:text-lg md:leading-8 ${className}`}
    >
      {children}
    </p>
  );
...
export const About = () => {
  return (
    <main className="h-full w-screen">
      <div className="flex flex-col gap-3 pb-6 md:grid md:grid-cols-2 md:gap-x-5 md:gap-y-3">
        <img
          loading="lazy"
          src={leanOnTree}
          className="w-full object-cover md:col-span-1 md:row-span-5 md:row-start-1 md:h-screen"
        />
        <div className="pt-5 pl-3 md:col-span-1 md:row-span-1 md:row-start-1 md:pt-50 md:pb-5">
          <PageHeader>Biography</PageHeader>
        </div>
        {/* <div className="flex flex-col gap-4"> */}
        <BioParagraph className="md:col-start-2 md:row-start-2">
        ...
        <BioParagraph className="md:col-start-2 md:row-start-3">
        ...
        <BioParagraph className="md:col-start-2">
        ...
        <BioParagraph className="md:col-start-1 md:pl-4">
        ...
        <BioParagraph className="md:col-span-full md:col-start-1 md:pl-4">
        ...
        <BioParagraph className="md:col-span-full md:pl-4">
